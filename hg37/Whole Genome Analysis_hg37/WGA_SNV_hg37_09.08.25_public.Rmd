---
title: "WGA_SNV_hg37_07.25 - Whole Genome SNV analysis for hg37 builds"
author: "Layla Ahmed"
date: "2025-06-24"
...
```{r}
#You are currently using the Single Nucleotide Variant (SNV) filter code specifically for Whole Genome Analysis in hg37.
...
pathogenicfiltering <- function(){
  ...
  strong_variants <<- rbind(effect_data,pathogenicfilter_data,spliceAI_data)
     ...
     strong_variants <<- rbind(effect_data,pathogenicfilter_data) 
   }
